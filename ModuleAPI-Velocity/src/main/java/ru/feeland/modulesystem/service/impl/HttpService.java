...
public class HttpService extends BaseService {
    ...
    public HttpService(BaseModuleSystemVelocity plugin) {
        super(plugin);
    ...
    public void failure(Player sender, HttpResponseContent content) {
        ...
        if (content.getApiExceptionResponse() != null) {
            ...
            sender.sendMessage(Component.text("Код ошибки: %d. %s".formatted(
                content.getApiExceptionResponse().getCode(),
                content.getApiExceptionResponse().getMessage()
            )));
        }
    ...
    public static class HttpResponseContent<T> {
        ...
        public ApiExceptionResponse getApiExceptionResponse() { return apiExceptionResponse; }

        public T getBody() { return body; }
        public Integer getCode() { return code; }
        public Throwable getException() { return exception; }
        public boolean isSuccess() { return getCode() != null && getCode() == 200; }
